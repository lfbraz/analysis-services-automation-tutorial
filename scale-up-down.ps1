...
[string] $resourceGroupName = "Resource-Group-Analytics",

[parameter(Mandatory=$false)]
[string] $azureRunAsConnectionName = "AzureRunAsConnection",

[parameter(Mandatory=$true)]
[string] $serverName = "ssastutorial",

[parameter(Mandatory=$true)]
[string] $scalingSchedule = "[{WeekDays:[0,1,2,3,4,5,6], StartTime:'06:59:59', StopTime:'19:35:00', Sku: 'S0'}, {WeekDays:[0,1,2,3,4,5,6], StartTime:'19:35:00', StopTime:'23:59:59', Sku: 'S1'}]",

[parameter(Mandatory=$false)]
[string] $scalingScheduleTimeZone = "E. South America Standard Time"
)
